...
public class Percabangan_EsTehManis {
    public static void main(String[] args) {
        String nama_barang = "Es Teh Manis";
        ...
        System.out.println("===============================================");
        System.out.println("========= APLIKASI PEMBELIAN ES TEH MANIS ========");
        System.out.println("===============================================");

        System.out.print("Masukkan Harga Es Teh Manis  : Rp ");
        harga = input.nextInt();
        ...
        System.out.println("Harga per Gelas     : Rp " + harga);
        ...
        System.out.println("===================================================");
        System.out.println("        Terima Kasih Telah Membeli Es Teh!         ");
    }
}
